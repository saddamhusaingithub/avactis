...
public class VerifyCartProductTest extends LoginTest {
	...
	@Test(dataProvider = "ProductDetails", priority = 1)
	public void verifyAddedProductsInUserCart(String productCategory1, String productSubCategory1, String product1,
		...
		// Add second product and get its price
		...
		// Add third product and get its price
		...
		// Click on Cart button showing total count of added products
		objProductListPage.clickOnTotalCartCounts();

		// Verify added products in user cart
	...
	@Test(dataProvider = "UserCheckoutDetails", priority = 2)
